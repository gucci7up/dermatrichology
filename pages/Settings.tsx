...
const Settings: React.FC = () => {
  ...
  const inputClasses = "w-full px-5 py-3 bg-white border border-sand-400 rounded-xl focus:ring-2 focus:ring-[#C15F3C] focus:border-[#C15F3C] outline-none transition-all placeholder-sand-400 text-sand-900 shadow-sm font-medium";
    ...
    <div className="max-w-4xl mx-auto space-y-10 animate-in fade-in slide-in-from-bottom-4 pb-20">
      ...
      <form onSubmit={handleSave} className="space-y-8">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              ...
              <div className="flex flex-col md:flex-row gap-8 items-start">
                <div className="relative w-48 h-48 rounded-2xl border-2 border-dashed border-sand-300 bg-sand-50 flex items-center justify-center overflow-hidden shadow-inner group">
                  {settings.logo_url ? (
                    <img
                    ...
                    <ImageIcon className="text-sand-300 w-12 h-12" />
                  )}
                </div>
                <div className="flex-1 space-y-6 w-full">
                  <div className="flex flex-wrap gap-3">
                    <label className="cursor-pointer bg-white border-2 border-sand-400 px-6 py-2.5 rounded-xl font-black text-sm text-sand-700 hover:bg-sand-50 hover:border-[#C15F3C] hover:text-[#C15F3C] transition-all shadow-sm flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-2 gap-4 pt-4 border-t border-sand-200">
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        <Maximize2 className="absolute left-3 top-3 w-4 h-4 text-sand-400 rotate-90" />
                        <input
                          type="number"
                    ...
                    <div className="space-y-1">
                      ...
                      <div className="relative">
                        <Maximize2 className="absolute left-3 top-3 w-4 h-4 text-sand-400" />
                        <input
                          type="number"
          ...
          <div className="space-y-8">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-1">
                ...
                <div className="relative">
                  <UserCircle className="absolute left-4 top-3.5 w-5 h-5 text-sand-400" />
                  <input
              ...
              <div className="space-y-1">
                ...
                <div className="relative">
                  <Briefcase className="absolute left-4 top-3.5 w-5 h-5 text-sand-400" />
                  <input
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-col sm:flex-row gap-6 items-start sm:items-center">
                <div className="relative w-32 h-32 rounded-full border-2 border-sand-300 bg-sand-50 flex items-center justify-center overflow-hidden shadow-xl ring-4 ring-white">
                  {settings.doctor_photo_url ? (
                    <img src={settings.doctor_photo_url} className="w-full h-full object-cover" alt="Doctor Preview" />
                  ) : (
                    <UserCircle className="text-sand-300 w-12 h-12" />
                  )}
                </div>
        ...
        <div className="flex items-center gap-4 sticky bottom-6 z-10">
          <button type="submit" className="flex-1 bg-[#C15F3C] hover:bg-[#8C4429] text-white py-5 rounded-2xl font-black shadow-2xl shadow-[#C15F3C]/20 flex items-center justify-center gap-3 transition-all active:scale-[0.98]">
